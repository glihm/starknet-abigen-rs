...
use starknet_abigen_parser::{abi_types::AbiTypeAny, CairoEnum};
...
impl Expandable for CairoEnum {
    ...
    fn expand_impl(&self, is_legacy: bool) -> TokenStream2 {
        ...
        let impl_line = if self.is_generic() {
            ...
            quote!(impl starknet_abigen_parser::cairo_types::CairoType for #enum_name)
        };
        ...
        quote! {
            #impl_line {
                ...
                fn deserialize(__felts: &[starknet::core::types::FieldElement], __offset: usize) -> starknet_abigen_parser::cairo_types::Result<Self::RustType> {
